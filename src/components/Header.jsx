...
function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-md border-b border-zinc-200 shadow-sm z-50">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <Link to="/" className="flex items-center gap-3 text-zinc-900 hover:text-zinc-700 transition-colors">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/register"
              className="bg-zinc-900 text-white px-6 py-2 rounded-lg hover:bg-zinc-800 transition-colors font-semibold"
            >
              {t('register')}
            </Link>
          </div>
